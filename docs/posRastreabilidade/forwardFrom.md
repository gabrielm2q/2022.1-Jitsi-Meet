...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ---- |
| RF01  | Eu quero me reunir com duas ou mais pessoas                                                                                                     | C01, C02, L08, FT02, FT04, FT05, FT09 |    [RF01](../assets/posRastreabilidade/iteracao.png)  |
| RF02  | Eu quero me comunicar via chat de texto                                                                                                         | C07, L14, FT10                        |   [RF02](../assets/posRastreabilidade/batePapo.jpeg)    |
| RF03  | Eu quero compartilhar minha tela com os outros participantes da conferência                                                                     | C03, L20, FT07                        |  [RF03](../assets/posRastreabilidade/compartilharTela.png)    |
| RF04  | Eu quero gerar links que direcionem para uma conferência                                                                                        | C01, C02, L08, L15, FT09              |  [RF04](../assets/posRastreabilidade/gerarLinks.png)    |
| RF05  | Eu quero fixar minha tela compartilhada para todos os integrantes                                                                               | C03, FT07                             |  [RF05](../assets/posRastreabilidade/fixarTela.png)    |
| RF06  | Eu quero que novos participantes sejam automaticamente mutados no chat de voz                                                                   | C04, C16, FT18                        |     [RF06](../assets/posRastreabilidade/participantNovoIniciaMutado.png) |
| RF07  | O Jitsi permite a criação de breakout rooms                                                                                                     | C06, L17, FT08, US13                  |    [RF07](../assets/posRastreabilidade/breackoutRoom.png)  |
| RF08  | Eu quero que exista uma restrição para que apenas pessoas permitidas entrem na reunião                                                          | C02, FT02, FT09                       |   [RF08](../assets/posRastreabilidade/salaDeEspera.jpeg)   |
| RF09  | O Jitsi permite que o dono da sala tenha funções de moderador na reunião                                                                        | C16, FT18                             |  [RF09](../assets/posRastreabilidade/moderador.png)    |
| RF10  | Eu quero que seja possível agendar as reuniões                                                                                                  | C01, FT01, US02                       |    [RF10](../assets/posRastreabilidade/)  |
| RF11  | Eu quero que seja possível "levantar a mão" durante as chamadas                                                                                 | C10, FT13, US20                       |  [RF11](../assets/posRastreabilidade/levantarMao.png)    |
| RF12  | Eu quero que seja possível aplicar filtros no plano de fundo do vídeo transmitido                                                               | C13, FT14                             |  [RF12](../assets/posRastreabilidade/filtro.jpeg)     |
| RF13  | Eu quero que seja possível escolher a forma de visualização e organização das telas/pessoas                                                     | L18, E04                              |   [RF18](../assets/posRastreabilidade/mododeExibicao.png)    |
| RF14  | Eu quero que seja possível se identificar na plataforma com nome                                                                                | C01, C02, C14, FT14 |    [RF13](../assets/posRastreabilidade/batePapo.jpeg)  |
| RF15  | Eu quero que seja possível se identificar na plataforma com foto                                                                                | C01, C02, C14, FT14 |  [RF15](../assets/posRastreabilidade/iniciarComNome.jpeg)    |
| RF16  | Eu quero que o usuário possa ativar um filtro de ruídos do áudio                                                                                | C15, FT17, FT05 | [RF16](../assets/posRastreabilidade/filtroDeRuido.png)     |
| RF17  | Eu quero que seja possível ver meu próprio vídeo durante o uso da plataforma                                                                    | C01, C02, C13, C15, FT04, FT16 | [RF17](../assets/posRastreabilidade/verPropriaTela.png)     |
| RF18  | Eu quero que seja possível alternar o idioma da plataforma                                                                                      | C14, FT15 |  [RF18](../assets/posRastreabilidade/idioma.png)    |
| RF19  | O Jitsi permite a visualização do histórico de reuniões                                                                                         | C08,FT03 |   [RF18](../assets/posRastreabilidade/mudancaDeEstado.png)   |
| RF20  | O Jitsi permite que o usuário configure o próprio áudio e vídeo                                                                                 | C15, FT16, FT17, FT18 |  [RF20](../assets/posRastreabilidade/configuracoesAudio.jpg) [RF20](../assets/posRastreabilidade/configuracoesCamera.jpg)   |
| RF21  | O Jitsi permite a interação entre os participantes por voz e vídeo                                                                              | C01, C02, FT04, FT05 |  [RF21](../assets/posRastreabilidade/iteracao.png)    |
| RF22  | O Jitsi permite que enquetes sejam feitas e respondidas em tempo real                                                                           | C11, C12, FT11 | [RF22](../assets/posRastreabilidade/)     |
| RF23  | O Jitsi permite reação com emotes pelos usuários                                                                                                | C07, FT12 |  [RF23](../assets/posRastreabilidade/emoticons.jpeg)    |
| RF24  | O Jitsi permite alterações no perfil durante a reunião                                                                                          | C14, FT14 |   [RF24](../assets/posRastreabilidade/fotoDePerfil.png)   |
| RF25  | O Jitsi permite que o usuário saia a qualquer momento da reunião                                                                                | C05 | [RF25](../assets/posRastreabilidade/sairComFacilidade.jpeg)     |
...
| RNF04 | O Jitsi deve ter uma interface que facilite a visualização das mudanças de estado na reunião                                                    |  [US08](../modelagem/agil/historiasDeUsuario.md)     |                                        [RNF04](../assets/posRastreabilidade/mudancaDeEstado.png)    |
